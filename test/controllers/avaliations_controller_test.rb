...
class AvaliationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliation" do
    assert_difference('Avaliation.count') do
      post avaliations_url, params: { avaliation: { description: @avaliation.description, user_id: @avaliation.user_id, validade: @avaliation.validade } }
    end
  ...
  test "should update avaliation" do
    patch avaliation_url(@avaliation), params: { avaliation: { description: @avaliation.description, user_id: @avaliation.user_id, validade: @avaliation.validade } }
